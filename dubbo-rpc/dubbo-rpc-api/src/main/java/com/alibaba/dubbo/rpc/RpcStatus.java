...
public class RpcStatus {
    ...
    private static final ConcurrentMap<String, RpcStatus> SERVICE_STATISTICS = Maps.newConcurrentMap();

    private static final ConcurrentMap<String, ConcurrentMap<String, RpcStatus>> METHOD_STATISTICS = Maps.newConcurrentMap();
    ...
    public static RpcStatus getStatus(URL url, String methodName) {
        ...
        if (map == null) {
            METHOD_STATISTICS.putIfAbsent(uri, Maps.newConcurrentMap());
