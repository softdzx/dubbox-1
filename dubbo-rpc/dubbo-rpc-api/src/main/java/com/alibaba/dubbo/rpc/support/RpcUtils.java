...
public class RpcUtils {
    ...
    public static boolean isAsync(URL url, Invocation inv) {
        //如果Java代码中设置优先.
        return Boolean.TRUE.toString().equals(inv.getAttachment(Constants.ASYNC_KEY)) || url.getMethodParameter(getMethodName(inv), Constants.ASYNC_KEY, false);
    }

    public static boolean isOneway(URL url, Invocation inv) {
        //如果Java代码中设置优先.
        return Boolean.FALSE.toString().equals(inv.getAttachment(Constants.RETURN_KEY)) || !url.getMethodParameter(getMethodName(inv), Constants.RETURN_KEY, true);
    }
