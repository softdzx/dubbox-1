...
public class OwnerServiceImpl extends AbstractService implements OwnerService {
    ...
    private List<Owner> toOverrideLiset(List<Provider> pList, List<Override> cList) {
        Map<String, Owner> oList = Maps.newHashMap();
        ...
        return Lists.newArrayList(oList.values());
    }
    ...
    public void saveOwner(Owner owner) {
        ...
        if (CollectionUtils.isEmpty(overrides)) {
            ...
            for (Override override : overrides) {
                ...
                String usernames = params.get("owner");
                usernames = Strings.isNullOrEmpty(usernames) ? owner.getUsername() : usernames + "," + owner.getUsername();
    ...
    private void doSave(Owner owner) {
