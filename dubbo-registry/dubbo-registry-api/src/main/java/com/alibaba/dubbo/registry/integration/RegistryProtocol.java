...
public class RegistryProtocol implements Protocol {
    ...
    private final Map<URL, NotifyListener> overrideListeners = Maps.newConcurrentMap();
    ...
    private final Map<String, ExporterChangeableWrapper<?>> bounds = Maps.newConcurrentMap();
    ...
    private <T> Invoker<T> doRefer(Cluster cluster, Registry registry, Class<T> type, URL url) {
        ...
        URL subscribeUrl = new URL(Constants.CONSUMER_PROTOCOL, NetUtils.getLocalHost(), 0, type.getName(),
    ...
    public void destroy() {
        List<Exporter<?>> exporters = Lists.newArrayList(bounds.values());
