...
public abstract class Wrapper {
    ...
    private static final Map<Class<?>, Wrapper> WRAPPER_MAP = Maps.newConcurrentMap(); //class wrapper map
    ...
    private static Wrapper makeWrapper(Class<?> c) {
        ...
        Map<String, Class<?>> pts = Maps.newHashMap(); // <property name, property types>
        Map<String, Method> ms = Maps.newLinkedHashMap(); // <method desc, Method instance>
        List<String> mns = Lists.newArrayList(); // method names.
        List<String> dmns = Lists.newArrayList(); // declaring method names.
