...
public class ExtensionLoaderTest {
    ...
    public void test_getExtensionLoader_NotSpiAnnotation() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(),
                    allOf(CoreMatchers.containsString("com.alibaba.dubbo.common.extensionloader.NoSpiExt"),
                            CoreMatchers.containsString("is not extension"),
                            CoreMatchers.containsString("WITHOUT @SPI Annotation")));
        }
    }
    ...
    public void test_getExtension_ExceptionNoExtension() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(), CoreMatchers.containsString("No such extension com.alibaba.dubbo.common.extensionloader.ext1.SimpleExt by name XXX"));
        }
    }
    ...
    public void test_getExtension_ExceptionNoExtension_WrapperNotAffactName() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(), CoreMatchers.containsString("No such extension com.alibaba.dubbo.common.extensionloader.ext6_wrap.WrappedExt by name XXX"));
        }
    }
    ...
    public void test_getExtension_ExceptionNullArg() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(), CoreMatchers.containsString("Extension name == null"));
        }
    }
    ...
    public void test_AddExtension() throws Exception {
        try {
            ...
            assertThat(expected.getMessage(), CoreMatchers.containsString("No such extension com.alibaba.dubbo.common.extensionloader.ext8_add.AddExt1 by name Manual"));
        }
    ...
    public void test_AddExtension_ExceptionWhenExistedExtension() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), CoreMatchers.containsString("Extension name impl1 already existed(Extension interface com.alibaba.dubbo.common.extensionloader.ext8_add.AddExt1)!"));
        }
    }
    ...
    public void test_AddExtension_Adaptive_ExceptionWhenExistedAdaptive() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), CoreMatchers.containsString("Adaptive Extension already existed(Extension interface com.alibaba.dubbo.common.extensionloader.ext8_add.AddExt1)!"));
        }
    }
    ...
    public void test_replaceExtension_ExceptionWhenNotExistedExtension() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), CoreMatchers.containsString("Extension name NotExistedExtension not existed(Extension interface com.alibaba.dubbo.common.extensionloader.ext8_add.AddExt1)"));
        }
    }
    ...
    public void test_replaceExtension_Adaptive_ExceptionWhenNotExistedExtension() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), CoreMatchers.containsString("Adaptive Extension not existed(Extension interface com.alibaba.dubbo.common.extensionloader.ext8_add.AddExt4)"));
        }
    }
    ...
    public void test_InitError() throws Exception {
        ...
        try {
            ...
            assertThat(expected.getMessage(), CoreMatchers.containsString("Failed to load extension class(interface: interface com.alibaba.dubbo.common.extensionloader.ext7.InitErrorExt"));
